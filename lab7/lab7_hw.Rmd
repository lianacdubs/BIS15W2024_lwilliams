...
```{r}
isscap_group_number <- as.factor(fisheries$isscaap_group_number)  
...
**There are 203???? HELPPPPP it's suppose to be 204 countries** 
...
```
????IS THIS CORRECT**1551 species were caught as part of the data**
