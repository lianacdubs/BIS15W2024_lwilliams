...
```{r}
#names(fisheries) #This gives the names of the variables. 
#dim(fisheries) #This gives the dimensions 17692 observations, 71 variables 
```
...
```
**1546 species were caught**

6. Which country had the largest overall catch in the year 2000?
```{r}
fisheries_tidy %>% 
  filter(year=="2000") %>% 
  summarize(across(c(country, catch)), max_catch = max(catch)) %>% 
  arrange(desc(catch))
```
