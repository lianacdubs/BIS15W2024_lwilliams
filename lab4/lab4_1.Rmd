...
```
#readr is explicit of the package we are use. the code will work without this. readr is apart of tidyverse. 
...
glimpse(fish)
```
there are 4,033 observations and 6 variables 
...
#every variable in own column
#every observation in own row 
#each cell has one value

Tidyverse helps clean, organize, and manage data. 
...
##dplyr (pronounded "de plyer")  takes a dataframe and chop it up how you need to make tidy and make summaries about the data. 
##dply is a package in tidyverse
...
##select allows us to pull out variables (columns) in a data frame. This is good for large data frames. 
...
```
# the data frame is now chopped up vertically 
