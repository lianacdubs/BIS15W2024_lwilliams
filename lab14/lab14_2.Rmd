...
#advantage if someone has R studio then, they can open the app or you can put it online and anyone can use it! 
#You don't need the code chunk you just need the code. You have to include the libraries 
...
ui <- dashboardPage(
  ...
  dashboardBody(
  fluidRow(
  box(width = 3, #control the size of the box 
